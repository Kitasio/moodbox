defmodule MoodboxWeb.RevisionOutcomeLive do
  ...
  def render(assigns) do
    ...
    <.container>
        ...
        <.centered_block>
          <div class="max-w-3xl mx-auto text-center px-4">
            <%= if String.to_integer(@score) >= 8 do %>
              <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6b2a6d]">
      ...
      <img
        class="hidden sm:block absolute z-10 bottom-0 sm:right-10 right-4 w-32 lg:w-56 transform transition-transform"
        src="https://moodbox.fly.storage.tigris.dev/right-flower.webp"
      />

      <img
        class="hidden sm:block absolute z-10 bottom-0 left-4 sm:left-10 w-32 lg:w-56 transform transition-transform"
