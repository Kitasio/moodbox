defmodule MoodboxWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 p-2 bg-white border block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MoodboxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MoodboxWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def h4(assigns) do
    ~H"""
    <h4 class={"md:text-xl w-full xl:text-2xl xl:tracking-wide leading-tight sm:leading-snug text-[#6b2a6d] font-semibold #{@class}"}>
      <%= render_slot(@inner_block) %>
    </h4>
    """
  end
